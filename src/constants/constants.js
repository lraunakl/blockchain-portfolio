...
export const TimeLineData = [
  { year: 2017, text: 'We Started freelancing projects on Fiver , Upwork etc  👨🏾‍💻', },
  { year: 2018, text: 'Started developing services in Data Science 👩🏾‍🔬 & Web Development 🕸', },  
  { year: 2019, text: 'Crossed 1M$ in net sales revenue 🎯', },
  { year: 2020, text: '1️⃣Got a 5 year partnership agreement with Avalanche blockchain🌟🐱‍🏍 \n 2️⃣Wrote an article Fintech Times 📃', },
  { year: 2021, text: "1️⃣Started exploring Blockchain Tech 🎓   \n 2️⃣ Took a Deep Dive into Blockchain Development 🔗₿🔗 \n 3️⃣🌟🎯 Completed Consensys Blockchain Developer Bootcamp", },
  { year: 2022, text: "🌟🎯 Launched new blockchain courses ⏩⚡Started Building Awesome Full Stack DAPPS 🔥 \n 🚀Working as a Freelance Smart Contract Developer🌕" , },
